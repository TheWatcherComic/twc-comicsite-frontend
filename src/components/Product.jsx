        ...
        <div class="flex flex-col justify-center  md:flex-row md:gap-x-5">
            <div className="flex items-center md:shrink-0 ">
                <div className="w-full object-cover md:w-72 lg:w-96 rounded-lg md:rounded-lg">
                    <img src={ComicData[1].image} alt="" class="drop-shadow-lg md:drop-shadow-lg" loading="lazy" />
                </div>
            </div>
            <div className="flex flex-col justify-center mx-5">
                <div className="flex">
                    <h1 className='mt-5 text-xl font-bold text-slate-900 md:text-4xl dark:sm:text-white'>{ComicData[1].title}</h1>
                </div>
                <div className="flex">
                    <p className='mt-5 text-base text-justify font-light text-slate-900 md:text-base dark:sm:text-white text-ellipsis overflow-hidden'>{ComicData[1].description}</p>
                </div>
