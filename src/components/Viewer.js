      ...
      <div class="flex flex-col justify-center items-center md:gap-x-5">
        ...
        <div className="flex flex-col justify-center mx-5">
          <div className="flex">
            ...
            <button class="bg-zinc-50 opacity-25 hover:opacity-100 fixed z-50 bottom-10 left-8 md:left-1/4 dark:bg-zinc-50 border-2 dark:border-zinc-700 border-zinc-50 w-20 h-20 rounded-full drop-shadow-lg flex justify-center items-center text-white text-4xl dark:hover:bg-zinc-200 hover:drop-shadow-2xl" onClick={handleBack}>
              <ChevronLeftIcon class="text-black w-10" />
            </button>
            <button class="bg-zinc-50 opacity-25 hover:opacity-100 fixed z-50 bottom-10 right-8 md:right-1/4 dark:bg-zinc-50 border-2 dark:border-zinc-700 border-zinc-50 w-20 h-20 rounded-full drop-shadow-lg flex justify-center items-center text-white text-4xl dark:hover:bg-zinc-200 hover:drop-shadow-2xl" onClick={handleNext}>
