...
const IssuesList = (props) => {
  ...
  return (
    ...
    <div className=' flex flex-col bg-neutral-100 dark:bg-black rounded-xl  lg:flex lg:flex-row md:justify-between items-center lg:max-w-7xl lg:mx-auto lg:py-10 lg:px-5'>
        <h1 className='font-extrabold text-3xl mb-5 mt-5  justify-center dark:text-white'>{ComicData[props.children].title}</h1>
        <div className='flex flex-col mb-5 mt-5 text-center lg:text-right'>
